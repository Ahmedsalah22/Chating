...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 03, 2021 at 12:01 PM
...
ALTER TABLE `chat`
  ...
  ADD CONSTRAINT `chat_ibfk_2` FOREIGN KEY (`servant_id`) REFERENCES `customer_servant` (`servant_id`) ON DELETE CASCADE ON UPDATE CASCADE;
